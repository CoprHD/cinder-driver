...
"""Driver for EMC CoprHD Shared FileSystems."""
...
class EMCShareDriver(driver.ShareDriver):
    ...
    def __init__(self, *args, **kwargs):
        super(EMCShareDriver, self).__init__(driver_handles_share_servers, *args, **kwargs)
    ...
    def _get_common_driver(self):
        return connection.ViPRStorageConnection(
