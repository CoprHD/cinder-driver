...
from manila.share.drivers.coprhd.helpers import project
from manila.share.drivers.coprhd.helpers import virtualarray
from manila.share.drivers.coprhd.helpers import virtualpool
...
class Volume(common.CoprHDResource):
    ...
    def storage_resource_query(self,
        ...
        if Volume.BLOCK == storageres_type and volume_name is not None:
            ...
            if snapshot_name is not None:
                from manila.share.drivers.coprhd.helpers import snapshot
